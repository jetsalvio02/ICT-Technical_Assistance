...
const ReportsPage = () => {
  ...
  const districtChartOptions: any = {
    ...
    xaxis: {
      categories: byDistrict?.map((d) => d.name) || [],
    },
    tooltip: { theme: "dark" },
  };
  ...
  const officeChartOptions: any = {
    ...
    dataLabels: { enabled: true, style: { colors: ["#000"] } },
    xaxis: {
      categories: byOffice?.map((o) => o.name) || [],
    },
    tooltip: { theme: "dark" },
  };
    ...
    >
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, lg: 6 }}>
          <DashboardCard title="Annual Requests by District/Cluster">
            {isLoading ? (
        ...
        <Grid size={{ xs: 12, lg: 6 }}>
          <DashboardCard title="Annual Requests by Office/School">
            {isLoading ? (
